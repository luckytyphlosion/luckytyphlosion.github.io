...
function AutoTTRecorderProj() {
  return (
    <div>
      ...
      <p><a href="https://github.com/luckytyphlosion/auto-tt-recorder">GitHub link</a></p>
      ...
      <p>The program has seen use on channels that upload Mario Kart Wii time trials, such as <a href="https://www.youtube.com/channel/UCxCPLtXIg43HRP6QZN8gyYQ">CTGP Records</a>, <a href="https://www.youtube.com/c/200ccCTGPRecords">200cc CTGP Records</a>, and <a href="https://www.youtube.com/c/CTGPKartRecords">CTGP Kart Records</a>.</p>
      <p>Various features were added into the program, such as:</p>
      <ul>
        <li>The ability to record ghosts from the <a href="https://chadsoft.co.uk/time-trials/">CTGP Revolution Ghost Database</a>, by supplying a link to the ghost from the Ghost Database website</li>
        <li>Automatic track downloading from <a href="https://ct.wiimm.de/">Wiimm’s custom track archive</a></li>
